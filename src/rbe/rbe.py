...
from .rbe_module import LocalFeatureTransformer, FineProcess, CoarseMatching, FineMatching
...
class RBE(nn.Module):
    ...
    def forward(self, data):
        ...
        image0_std = data['image0'].std(dim=[2,3], keepdim=True)  # Standard deviation.
        image0 = (data['image0'] - image0_mean) / (image0_std + eps)  # Normalize.
        ...
        # Fetch coarse flow for fine_process.
